...
{
    /// <inheritdoc />
    public partial class m790 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookmarkCollections", x => new { x.Id, x.BookmarkId, x.CollectionId });
                    table.ForeignKey(
                        name: "FK_BookmarkCollections_Bookmarks_BookmarkId",
                        column: x => x.BookmarkId,
                        principalTable: "Bookmarks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookmarkCollections_Collections_CollectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookmarkCollections_BookmarkId",
                table: "BookmarkCollections",
                column: "BookmarkId");

            migrationBuilder.CreateIndex(
                name: "IX_BookmarkCollections_CollectionId",
                table: "BookmarkCollections",
                column: "CollectionId");
